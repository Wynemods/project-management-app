...
function setupPasswordToggle(toggleBtn: HTMLButtonElement, passwordField: HTMLInputElement): void {
...
async function performRegistration(userName: string, email: string, password: string): Promise<RegisterResponse> {
